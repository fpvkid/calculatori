...
(function () {
    ...
    const calculators = [
        ...
        { title: 'Time Duration Calculator', slug: 'time-duration-calculator', icon: '⌛', cat: 'time', desc: 'Hours and minutes between two times or dates.', live: true },
        { title: 'Resistor Color Decoder', slug: 'resistor-color-calculator', icon: '🌈', cat: 'time', desc: 'Identify resistor values by their colored bands.', live: true },
        { title: 'Study Session Timer', slug: 'study-timer', icon: '📚', cat: 'time', desc: 'Pomodoro-style timer for deep work and exam prep.', live: true },
        ...
        { title: 'ADU Value Estimator', slug: 'adu-value-calculator', icon: '📈', cat: 'finance', desc: 'Estimate the property value increase from building an ADU.', live: true },
